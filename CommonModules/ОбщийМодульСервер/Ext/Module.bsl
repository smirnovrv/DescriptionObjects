...
Процедура ЗаполнитьРеквизитыОбъекта(Ссылка, ИБ) Экспорт
	...
	Структура.Вставить("ИБ"		, ИБ);
	
	ЗаполнитьРеквизиты(Структура); 
	//
	//Для Каждого Метаданное Из ИБ.Метаданные[Структура.тВид][Структура.ИД].ТабличныеЧасти Цикл 
...
Процедура ЗаполнитьРеквизиты(Структура) Экспорт 
     ИБ = ПодключитьсяКТекущейбазе(Структура.ИБ); 
